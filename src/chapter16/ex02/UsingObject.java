...
class Goods2 {
	...
	// setter: 필드의 값을 할당
	public void setObj(Object obj) {	// obj 변수에 자바의 모든 클래스(여러 타입)을 담을 수 있다.
		this.obj = obj;
	}
...
public class UsingObject {
	...
	public static void main(String[] args) {
		...
		g2.setObj(b1);		// b1: Banana ===> Object로 자동 업캐스팅 됨
		...
		g2.setObj(new Orange("오렌지"));	// Orange ==> Object로 업캐스팅 되어서 들어감.
