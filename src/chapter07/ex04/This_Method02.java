...
class Book {
	...
	Book(String bookName) {
		this();						// Book()를 호출		// this 메소드: 생성자 내부에서 다른 생성자 호출
		this.bookName = bookName;						// this 키워드: 필드명, 메소드명 앞에 붙임
	}
	
	// 매개변수가 2개 인풋: bookName, bookAuthor
	Book(String bookName, String bookAuthor) {
		this(bookName);
		this.bookAuthor = bookAuthor;
	}
	
	// 매개변수 3개 인풋: bookName, bookAuthor, bookPrice
	Book(String bookName, String bookAuthor, int bookPrice) {
		this(bookName, bookAuthor);
		this.bookPrice = bookPrice;
	}
	
	// 매개변수 4개 인풋: bookName, bookAuthor, bookPrice, bookCount
