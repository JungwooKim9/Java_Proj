...
class Student {
	...
	// 생성자: 매개변수로 1개 인풋 받는 생성자
		// this: 자기 자신의 객체를 뜻함
		// 매개변수로 들어오는 변수명, 매개변수로 들어오는 변수를 받는 변수명, 필드명, 이 세가지 이름이 동일할 경우
	...
	// 생성자: 매개변수 3개 받는 생성자
	public Student(String stuName, String stuAddr, String stuEamil) {
		this.stuName = stuName;
		this.stuAddr = stuAddr;
	...
	// 생성자: 매개변수 4개
	public Student(String stuName, String stuAddr, String stuEamil, int stuAge) {
		this.stuName = stuName;
		this.stuAddr = stuAddr;
		this.stuEamil = stuEamil;
		this.stuAge = stuAge;
	...
	public String toString() {
		return "Student [stuName=" + stuName + ", stuAddr=" + stuAddr + ", stuEamil=" + stuEamil + ", stuAge=" + stuAge
				+ ", stuWeight=" + stuWeight + "]";
	}
