...
class Aa {		// extends Object 생략 되어 있음
	...
	public static void main(String[] args) {
		/*
		 Object 클래스의 equals() 메소드: 기본적으로 == Stack의 주소를 비교하도록 설정
		 	equals() 메소드는 Heap의 값을 비교하는 것이 아니라 Stack 메모리의 참조 주소를 비교하도록 세팅
		 	// 그래서 equals() 메소드를 Heap의 값을 비교 할 수 있도록 재정의해서 사용해야함.
		...
		System.out.println(s1.equals(s2));		// true		// Object 클래스의 equals를 재정의해서 Heap의 값을 비교하도록 정의
