...
public class Using_Scanner {
	public static void main(String[] args) {
		...
		Scanner sc = new Scanner(System.in);
			// <ctrl + shift + o>: 외부 클래스를 imort
		
		// 변수 선언, 값은 콘솔에서 인풋 값을 각 변수에 할당
		String name;	// 이름
		int kor;		// 국어 점수
		int eng;		// 영어 점수
		int math;		// 수학 점수
		...
		double avg = sum / 3.0;			// 평균을 출력 할 때는 실수로 정의
		
		// 4. 입력 받은 값을 출력하고 합계 및 평균을 계산해서 출력
		System.out.printf("입력한 이름은 %s이고, 국어점수는 %d이고, 영어점수는 %d이고, 수학점수는 %d입니다.\n",
				name, kor, eng, math);
		System.out.printf("%s님의 합계는 %d이고, 평균 값은 %5.2f입니다.", name, sum, avg);
