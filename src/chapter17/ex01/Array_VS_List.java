	...
	public static void main(String[] args) {
		/*
		 배열:
		 	...
		 	- 배열은 방의 크기가 지정이 되면 수정이 불가능 합니다. 삭제 후 새로 생성해야 한다.
		 	- 배열은 방의 중간의 값을 제거시 자동으로 축소되거나 늘어나지 않는다.
		 	
		 컬렉션(프레임워크):
		 	- 방의 크기를 지정하지 않는다. <동적으로 늘어나고 줄어들음>, 무한정 늘어난다.
		 	- 동일한 타입의 값을 저장한다.
		 	- 제너릭 타입
		...
		// 출력
		System.out.println(Arrays.toString(arr));		// 배열의 중간의 값을 제거시 자동으로 축소되지 않는다.
		System.out.println("배열 방의 갯수: " + arr.length);
