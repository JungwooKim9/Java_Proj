...
// 2. 약식 표현: <== 많이 사용
interface B {
	int a = 3;		// public static final이 생략되어 있음
	void abc();		// public abstract이 생략되어 있음
}
	...
	public static void main(String[] args) {
		/*
		 인터페이스 (Interface): 내부와 외부를 연결시켜주는 접점. 콘센트 (가전제품 <==> 전기), 메뉴판 (손님 <==> 주방장)
		 			...
		 			- 모든 필드는 public static final이 생략되어 있다.	<== Interface의 필드의 값은 수정이 불가함
		 			...
		 			- 클래스는 여러 인터페이스를 구현 할 수 있다. (다중 상속이 가능하다) Implements
