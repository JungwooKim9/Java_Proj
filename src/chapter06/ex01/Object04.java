...
class Car{
	...
	// 필드(속성)
	String company;		// 제조사
	String carName;		// 차의 이름
	String carColor;	// 차의 색상
	int carSpeed;		// 차의 스피드
	...
	public void print() {
		...
		System.out.println("차의 이름: " + carName);
		System.out.println("차의 색상: " + carColor);
...
public class Object04 {
	...
	public static void main(String[] args) {
			// c1 객체: 현대자동차 / 그랜져 / 검은색 / 250 / 1.0톤
			// c2 객체: 쌍용자동차 / 투싼 / 노란색 / 300 / 2.0톤
			// c3 객체: 기아자동차 / K9 / 흰색 / 350 / 1.5톤
		...
		System.out.println("====================");
		Car out1 = arr1[0];			// arr1 0번 방의 객체 c1을 out1으로 끄집어 낸다.
