...
public class ConsoleOutput3 {
	public static void main(String[] args) {
		...
		// 변수 선언: Java와 JavaScript는 완전히 별개의 언어
			// <자료형> <변수명> = <변수에 들어갈 초기값>;
		...
		// int age2 = 77.7;	// 오류 발생 정수형 자료형에 실수를 대입해서 오류
		...
		// int age = 50;	// 오류 발생 age 변수를 새롭게 선언하는데 위에 선언 되어 있어서 오류
		...
		// 2. print(); 으로 출력: 문자열과 변수를 + 연결해서 출력
		...
		System.out.printf("나의 이름은 %s이고, 나이는 %d이고, 몸무게는 %4.1f입니다.\n", myName, age, weith);
