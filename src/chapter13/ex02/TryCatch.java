...
public class TryCatch {
	...
	public static void main(String[] args) {
		/*
		 ...
		 예외를 처리하는 방법
		 	1. throws로 미루는 방법: 마지막에 호출하는 곳에서 예외를 처리
		 			throw: 예외를 강제로 발생 시킬 때 사용
		 	2. try catch문을 사용해서 내가 직접 예외를 처리
		 */
		...
		System.out.println(3 / 0);			// 예외가 발생됨
			...
			// try 블락에서 오류가 발생 되면 catch 블락이 작동이 되고
			// try 블락에서 오류가 발생 되지 않으면 catch 블락이 작동되지 않음
			System.out.println("catch 블락 작동됨");
		} finally {		// try에서 오류가 발생해도, 발생하지 않아도 작동됨
