...
public class Array_Initial_Value {
	...
	public static void main(String[] args) {
		...
		// 1. Stack 메모리 값 (강제 초기화가 되지 않음)	<== 기본 자료형의 값
		int val1;		// 변수 선언
	...
	//	System.out.println(val2);		// 오류 발생, Heap 영역이 생성되지 않는 상태, new int[3]
		...
		System.out.println(val2);		// 객체의 힙 영역의 주소가 출력됨, 16진수
		...
		System.out.println("==================================");
		int[] val3 = null;	// 참조 자료형일 때만 객체 주소에 null 할당 할 수가 있음
		...
		System.out.println("char 기본 값은 공백: " + d[0]);
		System.out.println("char 기본 값은 공백: " + d[1]);
		System.out.println("char 기본 값은 공백: " + d[2]);
		System.out.println("=============");
		...
		// Arrays.toString(배열 변수);		// 배열의 모든 값을 출력
